...
import { getSubjects, addSubject, getCourses, getSemesters } from '../../../services/academicService';
...
const Subjects = () => {
    ...
    return (
        <div>
            ...
            <SimpleModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title="Add Subject">
